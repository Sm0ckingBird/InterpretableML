...
项目结构  
-mnist   
&ensp;&ensp;student\_mnist.py(简单的全连接)  
&ensp;&ensp;teacher\_mnist.py(复杂的全连接)  
&ensp;&ensp;distill\_mnist.py(知识蒸馏过程)  
&ensp;&ensp;distill\_mnist_unlabeled.py(不带标签的)  

-

-model  
&ensp;&ensp;data\_loader.py  
&ensp;&ensp;densenet.py  
&ensp;&ensp;net.py  
&ensp;&ensp;preresnet.py  
&ensp;&ensp;resnet.py  
&ensp;&ensp;resnext.py  
&ensp;&ensp;wrn.py  

-

-.  
&ensp;&ensp;count\_model\_size.py  
&ensp;&ensp;distillation\_analysis.py  
&ensp;&ensp;evaluate.py  
&ensp;&ensp;search\_hyperparams.py  
&ensp;&ensp;synthesize\_results.py  
&ensp;&ensp;train.py  
&ensp;&ensp;util.py  